...
`]},{title:"最新发布",headers:[{level:2,title:"v0.38.0 版本说明",slug:"v0-38-0-版本说明",link:"#v0-38-0-版本说明",children:[]},{level:2,title:"主要改进",slug:"主要改进",link:"#主要改进",children:[]},{level:2,title:"下载",slug:"下载",link:"#下载",children:[]}],path:"/zh/release/release-latest.html",pathLocale:"/zh/",extraFields:["最新发布",`v0.38.0 版本说明
在本次发布中，我们专注于改进设计器中的用户体验，特别是在画布导航和小部件管理方面。我们也解决了几个影响项目构建和模拟器启动的关键问题。
主要改进
