...
const config: Config = {
  ...
  url: 'https://lvgl-designer.github.io',
  ...
  organizationName: 'lvgl-designer', // Usually your GitHub org/user name.
  projectName: 'lvgl-designer.github.io', // Usually your repo name.
